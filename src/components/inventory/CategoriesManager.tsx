...
export const CategoriesManager = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingItem) {
        const { error } = await supabase.from("product_categories").update(formData).eq("id", editingItem.id);
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle>Phân loại hàng hóa</CardTitle>
      ...
      <CardContent>
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>{editingItem ? "Chỉnh sửa" : "Thêm mới"} phân loại</DialogTitle>
            </DialogHeader>
